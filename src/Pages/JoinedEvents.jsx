...
const JoinedEvents = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://a10-social-event-server-jodjzk0zv-habiburrahman1010s-projects.vercel.app/joined-events/${user.email}`)
            .then((res) => res.json())
    ...
    return (
        <div>
            ...
            <h2 className=" my-4 text-3xl text-center font-bold">Joined <span className="text-blue-700">Events</span></h2>
