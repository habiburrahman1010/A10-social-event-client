...
const EventDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://a10-social-event-server-jodjzk0zv-habiburrahman1010s-projects.vercel.app/events/${id}`)
      .then(res => res.json())
      .then(data => {
        setEvent(data);
  ...
  const handleJoin = () => {
    ...
    fetch(`https://a10-social-event-server-jodjzk0zv-habiburrahman1010s-projects.vercel.app/events/${id}/join`, {
      method: "POST",
